<template>
  <GuidedBeamWorkspace v-if="appStore.simpleMode && !appStore.inViewerMode" />
  <div v-else class="d-flex flex-column fill-height advanced-workspace">
...
import GuidedBeamWorkspace from '@/components/GuidedBeamWorkspace.vue';
